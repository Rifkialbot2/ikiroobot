...
PM_START_TEXT = """
ʜᴇʟʟᴏ' sᴇɴᴘᴀɪ ᴍʏ ɴᴀᴍᴇ @kingswibu
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! ʜɪᴛ` /help
Maintained by @kingswibu ♡︎
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/Zhimyrobot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/wibulegend02"),
        InlineKeyboardButton(
            text="ᴀᴅᴅᴏᴡɴᴇʀ", url=f"t.me/kingswibu?startgroup=true"
        ),
    ],
    [
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *zimybot*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Awesome Bots @Zhimyrobot
                 \n❍ Support Group @wibulegend01
                 \n❍ Assistant @kingswibu.
                 \nHere is the [💾Repository](https://github.com/robot/ngeleg).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *zimy*
                 \nHere is the [Source Code](https://github.com/gada/mmk) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
